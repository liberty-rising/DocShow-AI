class NivoAssistant:
    ...
    def get_bar_params(self):
        ...
        params = {
            ...
            "indexBy": [
                "string | (datum: RawDatum): string | number optional default:'id'",
            ...
            "valueScale": {
                ...
                "valueScale.type": ["string required", "linear symlog", "Scale type."],
            },
            "indexScale": {
                "indexScale": [
                ...
                "indexScale.type": ["string required", "band", "Scale type."],
                "indexScale.round": [
                    "boolean required",
            ...
            "maxValue": ["number | 'auto'optional default:'auto'", "Maximum value."],
            "valueFormat": [
            ...
            "margin": ["object optional", "Chart margin"],
            "theme": [
                "Theme optional",
            ...
            "borderRadius": ["number optional default:0", "Rectangle border radius."],
            "borderWidth": ["number optional default:0", "Width of bar border."],
            "borderColor": [
            ...
            "enableGridX": ["boolean optional default:false", "Enable/disable x grid."],
            "gridXValues": [
                "(number | string)[] optional",
                "Specify values to use for vertical grid lines.",
            ],
            "enableGridY": ["boolean optional default:true", "Enable/disable y grid."],
            "gridYValues": [
                "(number | string)[] optional",
