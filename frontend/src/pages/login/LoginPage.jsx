...
function LoginPage({ onLogin }) {
    ...
    const { updateAuth, updateEmailVerification, updateUserRole, isAuthenticated } = useAuth();
    ...
    useEffect(() => {
        if (location.state?.emailVerified) {
            setEmailVerifiedMessage('Email has been successfully verified. Please log in.');
        }
        if (isAuthenticated) {
            navigate('/dashboards');
        }
